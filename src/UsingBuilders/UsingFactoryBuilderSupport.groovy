...
class RobotFactory extends groovy.util.AbstractFactory {
...
class ForwardMoveFactory extends groovy.util.AbstractFactory {
  boolean isLeaf() { true }
...
class LeftTurnFactory extends groovy.util.AbstractFactory {
  boolean isLeaf() { true }
